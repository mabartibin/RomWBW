...
;
#DEFINE PLATFORM_NAME "Martins Kiste", " [", CONFIG, "]"
...
PCRTCENABLE	.SET	TRUE		; PCRTC: ENABLE PC STYLE CLOCK DRIVER (PCRTC.ASM)
PCRTC_BASE	.SET	$08		; Override RTC port
...
AY_CLK		.SET    7372800/4	; Quarter of CPU clock, 1843200Hz 
...
SPKPORT		.EQU	1		; SPK: THE PORT WITH THE SPEAKER IO BIT
SPKSHADOW	.EQU	0		; SPK: THE SHADOW VALUE FOR THE PORT THAT HAS TO BE MAINTAINED
SPKMASK		.EQU	00000001b	; SPK: THE BIT MASK TO ACTUALLY TOGGLE
