...
;
	...
	OR	A
	JP	Z, DONE_BOOT_BEEP 	; NO SOUND DEVICE SO NO BEEP
	LD	B,BF_SNDQUERY		; HBIOS SOUND QUERY FUNCTION
	LD	E,BF_SNDQ_DEV		; SUBFUNCTION DEVICE QUERY
	LD	C,0			; SOUND UNIT 0
	CALL	HB_DISPATCH		; RETURN DEVICE TYPE CODE AND IO PORTS - TYPE IN B, PORTS IN DE, HL
	LD	A,B
	CP	SNDDEV_AY38910
	JP 	Z, BOOT_BEEP_SND0_IS_AY    ; PLAY SOMETHING FANCY ON AY/YM2149
